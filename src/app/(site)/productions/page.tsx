                      ...
                      <div className="bg-gradient-to-r from-[#1a2332] to-[#243a52] px-6 py-5 rounded-t-2xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full sm:w-auto">
                          ...
                          <Link
                            ...
                            className="inline-flex items-center justify-center gap-2 bg-[#3ea8c8] text-white font-medium text-sm px-4 sm:px-5 py-2.5 rounded-lg hover:bg-[#2d8ba8] transition-colors whitespace-nowrap min-w-0 flex-1 sm:flex-initial"
                          >
                            View Full Report
